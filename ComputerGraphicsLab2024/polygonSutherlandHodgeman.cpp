...
/* Function to render rotated text
void renderRotatedText(float x, float y, const char* text, float angle) {
    glPushMatrix();
    glTranslatef(x, y, 0);
