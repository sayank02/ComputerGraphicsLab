...
// Helper functions
GLint roundGL(const GLfloat a) { return (GLint)(a + 0.5); }
...
GLint inside(GLint code) { return !code; }
GLint reject(GLint code1, GLint code2) { return code1 & code2; }
GLint accept(GLint code1, GLint code2) { return !(code1 | code2); }
